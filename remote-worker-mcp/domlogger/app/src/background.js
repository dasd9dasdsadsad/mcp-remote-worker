...
const backgroundScripts = [ "utils.js", "caido-auth.js", "handlers.js", "init.js", "shortcuts.js", "mcp-server.js" ];
...
const main = async () => {
    ...
    if (typeof mcpServer !== 'undefined') {
        ...
        console.log('[DOMLogger++] MCP server initialized');
    }
